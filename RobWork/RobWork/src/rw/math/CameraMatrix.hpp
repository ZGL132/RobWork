...
namespace rw { namespace math {
    ...
    template< class T = double > class CameraMatrix
    {
      public:
        ...
        {
            T len = ((*this) (2, 0) * v2d (0) + (*this) (2, 1) * v2d (1) + (*this) (0, 2));
            T x   = ((*this) (0, 0) * v2d (0) + (*this) (0, 1) * v2d (1) + (*this) (0, 2)) / len;
            T y   = ((*this) (1, 0) * v2d (0) + (*this) (1, 1) * v2d (1) + (*this) (1, 2)) / len;
...
namespace rw { namespace common {
    ...
    namespace serialization {
         ...
         */
        template<>
        void read (rw::math::CameraMatrix< double >& sobject, rw::common::InputArchive& iarchive,
                   const std::string& id);
         ...
         */
        template<>
        void read (rw::math::CameraMatrix< float >& sobject, rw::common::InputArchive& iarchive,
                   const std::string& id);

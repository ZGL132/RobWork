...
if(NOT DEFINED RWS_ENABLE_PYTHON)
    if(DEFINED USE_Python)
        set(RWS_ENABLE_PYTHON ${USE_Python} CACHE BOOL "Enable Python support in RobWorkStudio")
    else()
        set(RWS_ENABLE_PYTHON ON CACHE BOOL "Enable Python support in RobWorkStudio")
    endif()
endif()

if(RWS_ENABLE_PYTHON)
    ...
    set(RWS_USE_PYTHON false)
    set(RWS_USE_PYTHON2 false)
    set(RWS_USE_PYTHON3 false)
    set(PYTHON_LIBRARIES "")
    set(PYTHON_INCLUDE_DIRS "")
    message(STATUS "RobWorkStudio: Python DISABLED!")
endif()

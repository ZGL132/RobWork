 ...
 * @brief  `sdurws_ird_kinematics_contract_test` 的自有测试入口——安装
 *         testkit TestRecordListener（契约面用例级明细与 gtest XML 并存）。
 *
 * 设计依据：
 *   - 先例：requirements/contract_test/ContractTestMain.cpp（WP-14-T02
 *     同款——契约测试目标与单元测试目标同接报告设施，T-1 允许形态：仅
 *     测试目标链 testkit；modeling 更早先例）
 *

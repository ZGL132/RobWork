...
RobotModelSpec RobotModelXmlWriter::makeDefaultSixAxisModel (const QString& saveDirectory)
{
    ...
    // The vendor STL set is intentionally not copied into every project.  These
    // simple primitives preserve the base/shoulder/upper-arm/forearm/wrist
    // silhouette and make a saved project self-contained.
    ...
    appendPrimitive ("BasePedestal", "Base", "Cylinder", {{0.1, 0.1, 0.1}},
                     0.115, 0.060, {{0, 0, 0.030}}, {{0, 0, 0}}, urDark);
    appendPrimitive ("ShoulderHousing", "Joint1", "Cylinder", {{0.1, 0.1, 0.1}},
                     0.110, 0.145, {{0, 0, 0.035}}, {{0, 0, 0}}, urGray);
    appendPrimitive ("UpperArmShell", "Joint2", "Box", {{0.425, 0.105, 0.120}},
                     0.0, 0.0, {{-0.2125, 0, 0.030}}, {{0, 0, 0}}, urGray);
    appendPrimitive ("ElbowHousing", "Joint3", "Cylinder", {{0.1, 0.1, 0.1}},
                     0.092, 0.120, {{0, 0, 0}}, {{0, 90, 0}}, urDark);
    appendPrimitive ("ForearmShell", "Joint3", "Box", {{0.39243, 0.090, 0.105}},
                     0.0, 0.0, {{-0.196215, 0, 0.024}}, {{0, 0, 0}}, urGray);
    appendPrimitive ("Wrist1Housing", "Joint4", "Cylinder", {{0.1, 0.1, 0.1}},
                     0.075, 0.125, {{0, 0, 0.052}}, {{0, 0, 0}}, urGray);
    appendPrimitive ("Wrist2Housing", "Joint5", "Cylinder", {{0.1, 0.1, 0.1}},
                     0.064, 0.110, {{0, 0, 0.040}}, {{0, 90, 0}}, urDark);

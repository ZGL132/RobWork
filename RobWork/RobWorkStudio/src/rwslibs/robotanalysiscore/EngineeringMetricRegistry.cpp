...
EngineeringMetricRegistry::EngineeringMetricRegistry()
{
    const EngineeringMetricDefinition definitions[] = {
        ...
        {"kinematics.task.required.count", "Required task count", "count", "Kinematics"},
        {"kinematics.task.required.reachable_count", "Reachable required task count", "count", "Kinematics"},
        {"kinematics.task.optional.count", "Optional task count", "count", "Kinematics"},
        {"kinematics.task.optional.reachable_count", "Reachable optional task count", "count", "Kinematics"},
        {"geometry.compactness", "Structure compactness", "ratio", "Geometry"},
        {"geometry.kinematic_length", "Kinematic chain length", "m", "Geometry"},
        {"geometry.base_height", "Base height", "m", "Geometry"},
        {"geometry.cross_section.maximum", "Maximum cross section", "m2", "Geometry"},
        {"geometry.link_slenderness.maximum", "Maximum link slenderness", "ratio", "Geometry"},

...
| 字段 | 值 |
| --- | --- |
| 文档版本 | v0.12（RT-T11 实现落位登记；v0.11＝RT-T10 实现落位登记；v0.10＝RT-T09 实现落位登记；v0.9＝RT-T08 实现落位登记；v0.8＝RT-T07 实现落位登记；v0.7＝RT-T06 实现落位登记；v0.6＝RT-T05 实现落位登记；v0.5＝RT-T04 实现落位登记；v0.4＝RT-T03 实现落位登记；v0.3＝全链一致性审计消账〔含卡头版本对齐更正〕；v0.2＝FOUNDATION-CR-01 契约审查修正；v0.1＝首版草案） |
| 日期 | 2026-09-12 |

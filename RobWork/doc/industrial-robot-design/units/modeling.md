...
| 字段 | 值 |
| --- | --- |
| 文档版本 | v0.8（2026-09-22：WP-13-T07 实现落位登记——§3.3 T07 行 `Template.hpp/.cpp` 落位＋§9.5 增登 `MDL-TEMPLATE-DISABLED` 行＋§14.6 变更记录；v0.7＝2026-09-22 WP-13-T06 实现落位；v0.6＝2026-09-22 WP-13-T05 实现落位；v0.5＝2026-09-22 WP-13-T04 实现落位；v0.4＝2026-09-22 WP-13-T03 实现落位；v0.3＝2026-09-22 WP-13-T02 构建落位；v0.2＝2026-09-22 评审响应；v0.1＝2026-09-22 首版草案，WP-13-T01 交付物） |
| 日期 | 2026-09-22 |

...
| 字段 | 值 |
| --- | --- |
| 文档版本 | v0.8（RPT-T05 实现落位登记——§7.1/§7.2/§9.1 构建器 Builder.hpp/.cpp 落地＋§9 章首 ReportCancelToken/ReportProgress 契约承载；v0.7＝RPT-T04 实现落位登记、v0.6＝RPT-T03 实现落位登记、v0.5＝RPT-T02 实现落位登记、v0.4＝RPT-T01 构建落位登记、v0.3＝RPT 编译批次评审驱动的两处任务号漂移校正、v0.2＝全链一致性审计消账、v0.1＝首版草案） |
| 日期 | 2026-09-20 |

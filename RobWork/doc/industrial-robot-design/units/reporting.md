...
| 字段 | 值 |
| --- | --- |
| 文档版本 | v0.5（RPT-T02 实现落位登记——§3.5/§4.1/§7.3 契约头 Errors.hpp/Identity.hpp 落地＋RPT-\* 码清单按收编表引用登记＋首个 core/diagnostics 上游头消费；v0.4＝RPT-T01 构建落位登记、v0.3＝RPT 编译批次评审驱动的两处任务号漂移校正、v0.2＝全链一致性审计消账、v0.1＝首版草案） |
| 日期 | 2026-09-19 |
...
**本文档结束**（reporting 单元详细设计 v0.5，状态 `Draft`；对应任务 WP-12-T01。）

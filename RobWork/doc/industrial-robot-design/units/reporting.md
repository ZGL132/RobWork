...
| 字段 | 值 |
| --- | --- |
| 文档版本 | v0.7（RPT-T04 实现落位登记——§5 章节词表 Sections.hpp/.cpp＋§9.2 SectionProvider.hpp 接口＋注册表落地；v0.6＝RPT-T03 实现落位登记、v0.5＝RPT-T02 实现落位登记、v0.4＝RPT-T01 构建落位登记、v0.3＝RPT 编译批次评审驱动的两处任务号漂移校正、v0.2＝全链一致性审计消账、v0.1＝首版草案） |
| 日期 | 2026-09-19 |

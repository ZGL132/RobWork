...
| 字段 | 值 |
| --- | --- |
| 文档版本 | v0.8（PRJ-T06 修订/分支/元数据落位登记——RevisionIndex＋闭包双通道＋INV-M1/M2/M3 发布边界＋O-15/D-5，登记见 §15.4；v0.7＝PRJ-T05 对象库；v0.6＝PRJ-T04 格式契约与编码；v0.5＝PRJ-T03 写锁与路径；v0.4＝PRJ-T02 存储原语；v0.3＝PRJ-T01 构建落位；v0.2＝全链一致性审计消账；v0.1＝首版草案。卡头版本行于本版补齐 v0.5～v0.7 期间的漂移） |
| 日期 | 2026-09-09 |

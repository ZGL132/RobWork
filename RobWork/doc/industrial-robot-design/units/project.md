...
| 字段 | 值 |
| --- | --- |
| 文档版本 | v0.11（PRJ-T09 查询端口落位登记——IProjectQueryPort 六类只读视图/闭包约束/缓存/隔离，登记见 §15.4；v0.10＝PRJ-T08 打开与恢复；v0.9＝PRJ-T07 事务引擎；v0.8＝PRJ-T06 修订/分支/元数据；v0.7＝PRJ-T05 对象库；v0.6＝PRJ-T04 格式契约与编码；v0.5＝PRJ-T03 写锁与路径；v0.4＝PRJ-T02 存储原语；v0.3＝PRJ-T01 构建落位；v0.2＝全链一致性审计消账；v0.1＝首版草案） |
| 日期 | 2026-09-09 |

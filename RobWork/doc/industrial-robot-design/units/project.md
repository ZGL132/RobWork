...
| 字段 | 值 |
| --- | --- |
| 文档版本 | v0.15（PRJ-T13 撤销/重做服务落位登记——公共头 `UndoRedo.hpp`〔UndoRedoService/UndoRedoStatus/InverseRecord——实现口径①～③见 §15.4〕＋`src/UndoRedoServiceImpl.{hpp,cpp}`〔§5.5 逆命令提交/§6.9 会话栈与边界〕＋`ProjectStore.hpp` 增挂 `undoRedo()` 访问器；v0.14＝PRJ-T12 草稿服务；v0.13＝PRJ-T11 确认放行流；v0.12＝PRJ-T10 命令服务；v0.11＝PRJ-T09 查询端口；v0.10＝PRJ-T08 打开与恢复；v0.9＝PRJ-T07 事务引擎；v0.8＝PRJ-T06 修订/分支/元数据；v0.7＝PRJ-T05 对象库；v0.6＝PRJ-T04 格式契约与编码；v0.5＝PRJ-T03 写锁与路径；v0.4＝PRJ-T02 存储原语；v0.3＝PRJ-T01 构建落位；v0.2＝全链一致性审计消账；v0.1＝首版草案） |
| 日期 | 2026-09-09 |

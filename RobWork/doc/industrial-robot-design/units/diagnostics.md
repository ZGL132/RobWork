...
| 字段 | 值 |
| --- | --- |
| 文档版本 | v0.9（DIAG-T08 实现落位登记——脱敏与崩溃诊断文件落地＋实现口径登记见 §14.4；v0.8＝DIAG-T07 实现落位登记；v0.7＝DIAG-T06 实现落位登记；v0.6＝DIAG-T05 实现落位登记；v0.5＝DIAG-T04 实现落位登记；v0.4＝DIAG-T03 实现落位登记；v0.3＝DIAG-T02 构建落位登记；v0.2＝全链一致性审计消账；v0.1＝首版草案；各版变更记录见 §14.4） |
| 日期 | 2026-09-14 |

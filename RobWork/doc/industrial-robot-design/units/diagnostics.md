...
| 字段 | 值 |
| --- | --- |
| 文档版本 | v0.12（DIAG-T11 文档与门禁同步——本文与实现零偏差登记＋README 指向核对零偏差＋§14.3 P-DIAG-1~9 状态逐条同步＋P-PR-6/P-EX-8 消账确认提交〔不私改对端契约〕＋§1.2 卡头一处措辞更正，登记见 §14.4；v0.11＝DIAG-T10 实现落位登记——测试替身与契约套件〔ScriptedDiagSource＋DT-\* 用例体收口〕落地＋实现口径登记见 §14.4；v0.10＝DIAG-T09 实现落位登记——诊断生命周期与容量〔目录清理策略/宿主留痕形状〕落地＋实现口径登记见 §14.4；v0.9＝DIAG-T08 实现落位登记；v0.8＝DIAG-T07 实现落位登记；v0.7＝DIAG-T06 实现落位登记；v0.6＝DIAG-T05 实现落位登记；v0.5＝DIAG-T04 实现落位登记；v0.4＝DIAG-T03 实现落位登记；v0.3＝DIAG-T02 构建落位登记；v0.2＝全链一致性审计消账；v0.1＝首版草案；各版变更记录见 §14.4） |
| 日期 | 2026-09-15 |

...
| 字段 | 值 |
| --- | --- |
| 文档版本 | v0.5（DIAG-T04 实现落位登记——§1.2 构建落位字段实测刷新＋实现口径登记见 §14.4；v0.4＝DIAG-T03 实现落位登记；v0.3＝DIAG-T02 构建落位登记；v0.2＝全链一致性审计消账；v0.1＝首版草案；各版变更记录见 §14.4） |
| 日期 | 2026-09-14 |

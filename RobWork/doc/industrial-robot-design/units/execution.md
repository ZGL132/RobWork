...
| 字段 | 值 |
| --- | --- |
| 文档版本 | v0.11（EX-T09 契约测试套件落地登记——§15.4 变更记录行；契约语义零变更；v0.10＝EX-T08 实现落位登记；v0.9＝EX-T07 实现落位登记；v0.8＝EX-T06 实现落位登记；v0.7＝EX-T05 实现落位登记；v0.6＝EX-T04 实现落位登记；v0.5＝EX-T03 实现落位登记；v0.4＝EX-T02 实现落位登记；v0.3＝EX-T01 构建落位登记；v0.2＝全链一致性审计消账；v0.1＝首版草案。卡头版本行 v0.5→v0.11 一次性追平——v0.6~v0.10 落位期仅更新了 §15.4 未同步卡头〔F-175 家族同型微瑕，本行消账〕） |
| 日期 | 2026-09-19 |

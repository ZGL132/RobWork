...
| 字段 | 值 |
| --- | --- |
| 文档版本 | v0.4（EX-T02 实现落位登记——卡头构建落位行更新＋§15.4 变更记录行＋一处头内归置登记（ArchivePhase 落 TaskTypes.hpp，防头循环）；契约语义零变更；v0.3＝EX-T01 构建落位登记；v0.2＝全链一致性审计消账；v0.1＝首版草案） |
| 日期 | 2026-09-18 |

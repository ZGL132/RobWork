...
| 字段 | 值 |
| --- | --- |
| 文档版本 | v0.6（2026-09-26，WP-15-T06 落位登记——§14.6；v0.5＝2026-09-26 WP-15-T05 落位登记；v0.4＝2026-09-26 WP-15-T04 落位登记；v0.3＝2026-09-26 WP-15-T03 落位登记；v0.2＝2026-09-26 WP-15-T02 落位登记；v0.1 首版草案 2026-09-22，WP-15-T01 交付物） |
| 日期 | 2026-09-26（v0.6）；2026-09-26（v0.5）；2026-09-26（v0.4）；2026-09-26（v0.3）；2026-09-26（v0.2）；2026-09-22（v0.1） |
...
| 构建落位 | `RobWork/RobWorkStudio/src/rwslibs/industrialrobot/kinematics/`（**WP-15-T02 起为真实目标**：`sdurws_ird_kinematics` STATIC（C++17、零 Qt、PUBLIC 链 core/diagnostics/runtime/policy/evidence/execution 六条 §3.2 登记边；PRIVATE 链 Eigen3——O-40，见 §14.6 v0.3）＋`_test`/`_contract_test` 两测试目标＋配置期红线守卫；T02 公共面＝Errors/DiagCodes 两头，T03 公共面＝KinTypes/Fk/Evaluators 三头，T04 公共面＝Ik/SolutionSet/Bounds 三头＋KinTypes 表尾追加，T05 公共面＝Evidence.hpp 新增＋Evaluators 表尾追加，T06 公共面＝Sampling/Coverage 两头新增＋Evaluators 表尾追加；`_plugin` 随 WP-15-T12，见 §3.2、§11） |

...
| --- | --- |
| 文档代号 | UNIT-UI |
| 文档版本 | v0.9（WP-10-T07 阶段 A 落位登记：统一工程策略入口——策略摘要只读卡＋PolicySummaryCard.hpp 呈现契约头＋PolicySummaryProjection 逐字段细化〔C-10 首消费〕、§12.3 UI-POL-1 用例行、§16.7 v0.9 行；v0.8＝WP-10-T06 落位登记、v0.7＝WP-10-T05 阶段 A 落位登记、v0.6＝WP-10-T04 落位登记、v0.5＝WP-10-T03 落位登记、v0.4＝O-31 裁决落地、v0.3＝WP-10-T02 落位登记、v0.2＝全链一致性审计消账、v0.1＝首版草案） |
| 日期 | 2026-09-21 |

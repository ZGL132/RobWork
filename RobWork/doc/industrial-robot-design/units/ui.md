...
| --- | --- |
| 文档代号 | UNIT-UI |
| 文档版本 | v0.7（WP-10-T05 阶段 A 落位登记：中央区三维视图占位＋视图契约登记——View3DContract.hpp 公共头〔UX-11 九项交互清单＋KIN-06/AT-04 会话姿态语义钉住〕、§3.3 头布局增行、§12.3 UI-V3D-1 用例行、§13 阶段 A 落地注；v0.6＝WP-10-T04 落位登记、v0.5＝WP-10-T03 落位登记、v0.4＝O-31 裁决落地、v0.3＝WP-10-T02 落位登记、v0.2＝全链一致性审计消账、v0.1＝首版草案） |
| 日期 | 2026-09-21 |

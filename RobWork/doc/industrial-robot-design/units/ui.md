...
| --- | --- |
| 文档代号 | UNIT-UI |
| 文档版本 | v0.6（WP-10-T04 落位登记：§6.3 七态承载首消费冻结——C-7 端口 IUiCurrentnessSource＋StatusWordProjection 及触发投影值形态＋九态短标签键；v0.5＝WP-10-T03 落位登记、v0.4＝O-31 裁决落地、v0.3＝WP-10-T02 落位登记、v0.2＝全链一致性审计消账、v0.1＝首版草案） |
| 日期 | 2026-09-21 |

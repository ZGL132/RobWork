...
| --- | --- |
| 文档代号 | UNIT-UI |
| 文档版本 | v0.8（WP-10-T06 落位登记：CommandRegistry＋GlobalShortcutRegistry＋命令面板——ICommandRegistry/IGlobalShortcutRegistry/UiTypes 公共头、UiPorts.hpp C-4 命令网关端口、UiProjections.hpp 命令信封/结果投影、§3.1 测试目标链接面增量〔Qt6::Test〕、§12.3 UI-PALETTE-1/2/3 用例行、§16.7 v0.8 行；v0.7＝WP-10-T05 阶段 A 落位登记、v0.6＝WP-10-T04 落位登记、v0.5＝WP-10-T03 落位登记、v0.4＝O-31 裁决落地、v0.3＝WP-10-T02 落位登记、v0.2＝全链一致性审计消账、v0.1＝首版草案） |
| 日期 | 2026-09-21 |

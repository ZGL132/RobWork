...
| 字段 | 值 |
| --- | --- |
| 文档版本 | v0.20（Draft；插件 GUI 手动验证通道约定增补——owner 指示 2026-09-26：每个 `_plugin` 交付任务完成时必须可经 VS 集成编译后手动 GUI 验证界面功能，见 §5.1/§5.2/§7）；v0.19（Draft；O-43 裁决登记——宿主深度融合形态承接（WP-10-T17 立项＋WP-10-T18 授权）；见 §7 变更记录） |
| 日期 | 2026-09-26 |
| 状态 | **`Draft`** |
| 文档代号 | DTB |

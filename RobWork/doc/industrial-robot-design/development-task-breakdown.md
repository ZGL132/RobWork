...
| 字段 | 值 |
| --- | --- |
| 文档版本 | v0.21（Draft；WP-24-T01 冻结版本基线首版登记＋WP-24-T03 拆段〔T03a 首版装配 2026-09-26 提前落位——owner 指示"每完成一个插件进行装配"〕，见 §2.25/§7；版本号承接 wp13-t15-app 分支 v0.20 先推序）；v0.19（Draft；O-43 裁决登记——宿主深度融合形态承接（WP-10-T17 立项＋WP-10-T18 授权）；见 §7 变更记录） |
| 日期 | 2026-09-24 |
| 状态 | **`Draft`** |
| 文档代号 | DTB |

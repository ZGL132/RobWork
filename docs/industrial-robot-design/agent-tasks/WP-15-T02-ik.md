...
- **证据工件：** `evidence/WP-15/ik-ordering-report.md`（排序键全序说明、种子/线程数、候选序列逐字节对照、3627db1 回归夹具说明）＋测试日志（命令、commit、配置、manifest 哈希）；独立算法验证者复核夹具与全序性。
- **提交格式：** `WP-15-T02: implement ik candidates`

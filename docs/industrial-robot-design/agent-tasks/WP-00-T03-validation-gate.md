...
- **前置任务及必需工件：** WP-00-T02；工件：`docs/industrial-robot-design/requirement-traceability.csv`（124 行、与生成器输出逐字节一致）与 `out/test-evidence/wp-00/<run-id>/t02-generation-log.md`。
- **允许创建/修改/删除的文件：**

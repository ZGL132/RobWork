...
- **基线 commit：**代码 `94fb910e8d4b1e2bb84d569cbca4aa623cbd2844`；文档：requirements v0.7、检查点 `IRD-D2-20260829`、module-design/core-domain.md v0.3。
...
- **证据工件：**`evidence/WP-03/T01/`：类型编译失败样例、非有限/零轴回归日志、容差报告、测试命令输出与提交 SHA。
- **提交格式：**`WP-03-T01: typed engineering values`。

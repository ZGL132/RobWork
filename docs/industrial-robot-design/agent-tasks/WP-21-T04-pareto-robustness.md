...
- **证据工件：** `evidence/WP-21/t04-pareto-robustness/`：误淘汰审计报告（分层键、抽样数、误淘汰率与 95% 置信上界）、三模式结果样例（64 点 LHS 样本身份）、覆盖对象清单、命令原文与 commit。

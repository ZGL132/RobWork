...
$requirementMap = @{
    ...
    'DYN-08' = @{ primary = 'WP-17'; supporting = @(); tasks = @('WP-17-T03'); tests = @('PowerEnergyTest','WPlusTrapezoidMatchesGolden','PowerSignConvention'); evidence = 'out/test-evidence/wp-17/<run-id>/'; gate = 'C-GATE' }
    ...
    'MDL-01' = @{ primary = 'WP-13'; supporting = @(); tasks = @('WP-13-T01','WP-13-T02'); tests = @('ModelFixtureTest','robotId','buildCommand'); evidence = 'out/test-evidence/wp-13/<run-id>/'; gate = 'B-GATE' }
    ...
    'MDL-11' = @{ primary = 'WP-13'; supporting = @(); tasks = @('WP-13-T01','WP-13-T03'); tests = @('ModelFixtureTest','Defaulted','UrdfImportTest'); evidence = 'out/test-evidence/wp-13/<run-id>/'; gate = 'B-GATE' }
    ...
    'NFR-PERF-03' = @{ primary = 'WP-23'; supporting = @('WP-10'); tasks = @('WP-23-T03','WP-10-T01','WP-10-T03','WP-10-T05'); tests = @('BenchmarkTest','EditDraft','applyDraft'); evidence = 'out/test-evidence/wp-23/<run-id>/'; gate = 'C-GATE' }
    ...
    'OPT-04' = @{ primary = 'WP-20'; supporting = @('WP-21'); tasks = @('WP-20-T04','WP-12-T02','WP-21-T02','WP-21-T04','WP-21-T06'); tests = @('StaticParetoTest','OnlyThreeStageBMetricsComputable','DominanceRequiresToleranceExceededStrictWin'); evidence = 'out/test-evidence/wp-20/<run-id>/'; gate = 'B-GATE/D-GATE' }
    ...
    'OPT-08' = @{ primary = 'WP-20'; supporting = @('WP-21'); tasks = @('WP-20-T04','WP-20-T06','WP-20-T07','WP-12-T04','WP-12-T05','WP-21-T05','WP-21-T06'); tests = @('StaticParetoTest','OnlyThreeStageBMetricsComputable','DominanceRequiresToleranceExceededStrictWin'); evidence = 'out/test-evidence/wp-20/<run-id>/'; gate = 'B-GATE/D-GATE' }
    'OPT-09' = @{ primary = 'WP-21'; supporting = @(); tasks = @('WP-21-T04','WP-21-T06','WP-12-T04','WP-12-T05'); tests = @('ParetoRobustnessTest','AcceptanceEvidenceTest','EvidencePackageTest'); evidence = 'out/test-evidence/wp-21/<run-id>/'; gate = 'D-GATE' }
    ...
    'SEL-06' = @{ primary = 'WP-19'; supporting = @(); tasks = @('WP-19-T03','WP-19-T05'); tests = @('ConstraintFilterTest','HardEliminationBeforeMargin','EveryEliminationCarriesCodeValueThreshold'); evidence = 'out/test-evidence/wp-19/<run-id>/'; gate = 'C-GATE' }
    ...
    'SEL-08' = @{ primary = 'WP-19'; supporting = @(); tasks = @('WP-19-T06'); tests = @('CatalogVersionTest','CatalogUpdateDoesNotChangeHistoricalResults','OldVersionStaysLocked'); evidence = 'out/test-evidence/wp-19/<run-id>/'; gate = 'C-GATE' }
    ...
    'TRJ-07' = @{ primary = 'WP-16'; supporting = @(); tasks = @('WP-16-T05','WP-10-T02'); tests = @('ResolvedIkBranchSequenceRecordsAdoptedSolutions','TrajectoryPlanPayloadCompletePerSchemaV1','EnvelopePassesLegalCombinationValidation'); evidence = 'out/test-evidence/wp-16/<run-id>/'; gate = 'C-GATE' }
    ...
    'UX-01' = @{ primary = 'WP-10'; supporting = @('WP-22'); tasks = @('WP-10-T01','WP-10-T02','WP-10-T03','WP-13-T08','WP-14-T07','WP-20-T07','WP-22-T01','WP-22-T02','WP-22-T04','WP-22-T05','WP-25-T03'); tests = @('EditDraft','applyDraft','SessionStateTest'); evidence = 'out/test-evidence/wp-10/<run-id>/'; gate = 'B-GATE/C-GATE/D-GATE/R-GATE' }
    'UX-02' = @{ primary = 'WP-10'; supporting = @('WP-22'); tasks = @('WP-10-T01','WP-10-T02','WP-10-T03','WP-10-T05','WP-09-T02','WP-13-T08','WP-14-T07','WP-20-T07','WP-22-T04','WP-22-T05','WP-25-T03'); tests = @('EditDraft','applyDraft','SessionStateTest'); evidence = 'out/test-evidence/wp-10/<run-id>/'; gate = 'B-GATE/C-GATE/D-GATE/R-GATE' }
    'UX-03' = @{ primary = 'WP-09'; supporting = @('WP-10','WP-22'); tasks = @('WP-09-T01','WP-09-T02','WP-09-T03','WP-10-T01','WP-10-T02','WP-10-T03','WP-13-T08','WP-14-T07','WP-20-T07','WP-22-T02','WP-22-T04','WP-22-T05','WP-25-T03'); tests = @('DiagnosticSchemaTest','CatalogTermsTest','DiagnosticCatalogContractTest'); evidence = 'out/test-evidence/wp-09/<run-id>/'; gate = 'B-GATE/C-GATE/D-GATE/R-GATE' }
    'UX-04' = @{ primary = 'WP-10'; supporting = @('WP-22'); tasks = @('WP-10-T01','WP-10-T02','WP-10-T03','WP-13-T08','WP-14-T07','WP-20-T07','WP-22-T05','WP-25-T03'); tests = @('EditDraft','applyDraft','SessionStateTest'); evidence = 'out/test-evidence/wp-10/<run-id>/'; gate = 'B-GATE/C-GATE/D-GATE/R-GATE' }
    'UX-05' = @{ primary = 'WP-10'; supporting = @('WP-22'); tasks = @('WP-10-T01','WP-10-T02','WP-10-T03','WP-13-T08','WP-14-T07','WP-20-T07','WP-22-T05','WP-25-T03'); tests = @('EditDraft','applyDraft','SessionStateTest'); evidence = 'out/test-evidence/wp-10/<run-id>/'; gate = 'B-GATE/C-GATE/D-GATE/R-GATE' }
    'UX-06' = @{ primary = 'WP-10'; supporting = @('WP-22'); tasks = @('WP-10-T01','WP-10-T02','WP-10-T05','WP-09-T02','WP-09-T04','WP-13-T08','WP-14-T07','WP-20-T07','WP-22-T01','WP-22-T02','WP-22-T03','WP-22-T05','WP-25-T03'); tests = @('EditDraft','applyDraft','SessionStateTest'); evidence = 'out/test-evidence/wp-10/<run-id>/'; gate = 'B-GATE/C-GATE/D-GATE/R-GATE' }
    'UX-07' = @{ primary = 'WP-10'; supporting = @('WP-22'); tasks = @('WP-10-T01','WP-10-T02','WP-13-T08','WP-14-T07','WP-20-T07','WP-22-T05','WP-25-T03'); tests = @('EditDraft','applyDraft','SessionStateTest'); evidence = 'out/test-evidence/wp-10/<run-id>/'; gate = 'B-GATE/C-GATE/D-GATE/R-GATE' }
    'UX-08' = @{ primary = 'WP-07'; supporting = @('WP-10','WP-22'); tasks = @('WP-07-T01','WP-10-T01','WP-10-T02','WP-10-T04','WP-13-T08','WP-14-T07','WP-20-T07','WP-22-T05','WP-25-T03'); tests = @('PolicyNormalizationTest','EditDraft','applyDraft'); evidence = 'out/test-evidence/wp-07/<run-id>/'; gate = 'B-GATE/C-GATE/D-GATE/R-GATE' }
